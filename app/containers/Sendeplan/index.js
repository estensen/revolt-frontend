...
let mandag = require('../../../mandag.json');
let tirsdag = require('../../../tirsdag.json');
let onsdag = require('../../../onsdag.json');
let torsdag = require('../../../torsdag.json');
let fredag = require('../../../fredag.json');
let lordag = require('../../../lordag.json');
let sondag = require('../../../sondag.json');
